...
class AgcSoybeanHarvestLossInputs {
    constructor() {
        this.socket = "";
        this.ready = false;
    }
    render() {
        return (h("section", { "data-wizard-results": true, ref: c => this.section = c },
            ...
            h("div", { style: { display: this.ready ? 'block' : 'none' } }, this.data && (h("ul", { class: "agc-results" },
                h("li", null,
                    h("h2", { "data-i18n": "results.beans-counted" }, "Beans Counted"),
                    h("span", { class: "agc-results__value" }, this.data['beansCounted'])),
                h("li", null,
    ...
    static get is() { return "agc-soybean-harvest-loss-inputs"; }
...
export { AgcSoybeanHarvestLossInputs };
