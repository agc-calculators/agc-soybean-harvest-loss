...
class AgcSoybeanHarvestLoss {
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: (e) => e.preventDefault(), ref: c => this.form = c, "data-wizard": "agc-soybean-harvest-loss", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        h("label", { "data-i18n": "fields.beans-counted" }, "Beans Counted"),
                        h("input", { name: "beansCounted", type: "number", required: true, min: "0", step: "1" }),
                        h("p", { class: "agc-wizard__validation-message", "data-i18n": "validation.beans-counted.required", "data-validates": "beansCounted" }, "Please enter a whole number of zero or greater."),
                        h("p", { "data-i18n": `hints.beans-counted` }, "\u2BA4 Enter the number of beans counted on the ground within the specified area.")),
                ...
                h("section", { "data-wizard-section": "1" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { class: "agc-wizard__validation-message", "data-i18n": "validation.loss-area.required", "data-validates": "lossArea" }, "Please enter a whole number of one or greater."),
                        h("p", { "data-i18n": `hints.loss-area.${this.units.lossArea}` }, "\u2BA4 Enter the area in square feet that was used to count beans on the ground.")),
    ...
    showResults() {
        let beansCounted = parseInt(this.form.querySelector('[name="beansCounted"').value);
    ...
    static get is() { return "agc-soybean-harvest-loss"; }
